...
namespace _102190156_TranKimTienDat
{
    class QLKH_BLL
    {
        ...
        public DataTable getAllSanPham_BLL(string ten, int ncc)
        {
            return ViewModel(QLKH_DAL.Instance.getAllSanPham_DAL(ten, ncc));
        }
        ...
        private DataTable ViewModel(List<SanPham> sps)
        {
            ...
            foreach (var sp in sps)
            {
                ...
                NCC ncc = QLKH_DAL.Instance.getNCC_DAL(sp.MaNCC);
                dr[5] = ncc.TenNCC;
